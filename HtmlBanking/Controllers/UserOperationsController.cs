...
namespace HtmlBanking.Controllers
{
    ...
    public class UserOperationsController : Controller
    {
        ...
        public UserOperationsController( ApplicationUserManager userManager, ApplicationSignInManager signInManager )
        {
        ...
        public ActionResult LinkLogin( string provider )
        {
            ...
            return new AccountController.ChallengeResult( provider, Url.Action( "LinkLoginCallback", "UserOperations" ),
